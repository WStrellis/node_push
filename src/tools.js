...
function getVapidKeys() {
    ...
    if (!keys.publicKey || !keys.privateKey) {
        ...
        console.log('Private VAPID key (masked):', "X".repeat(keys.privateKey.length))
        console.log('Public VAPID key or Private VAPID key not found. You can use these:',generatedKeys)
        return null
    }
